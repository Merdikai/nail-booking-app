          ...
          <div className="cta-content">
            ...
            <div className="cta-right">
              <div className="cta-image-grid">
                <img src="https://images.unsplash.com/photo-1604654894610-df63bc536371?w=150&h=150&fit=crop" alt="Nail 1" className="cta-img cta-img-1" />
                <img src="https://images.unsplash.com/photo-1519014816548-bf5fe059798b?w=150&h=150&fit=crop" alt="Nail 2" className="cta-img cta-img-2" />
                <img src="https://images.unsplash.com/photo-1607779097040-26e80aa78e66?w=150&h=150&fit=crop" alt="Nail 3" className="cta-img cta-img-3" />
                <img src="https://images.unsplash.com/photo-1632345031435-8727f6897d53?w=150&h=150&fit=crop" alt="Nail 4" className="cta-img cta-img-4" />
              </div>
            </div>
          </div>
        </div>
